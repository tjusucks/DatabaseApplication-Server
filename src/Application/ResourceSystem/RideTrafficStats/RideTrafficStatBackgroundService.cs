...
{  
    ...
    {  
        ...
        var operationalRides = await amusementRideRepository.SearchAsync(  
            searchTerm: null,  
            status: Domain.Enums.ResourceSystem.RideStatus.Operating,  
            location: null, managerId: null, minCapacity: null, maxCapacity: null,  
            minHeightLimit: null, maxHeightLimit: null, openDateFrom: null, openDateTo: null,  
    ...
    {  
        ...
        while (true)  
        {  
            var oldStats = await repository.SearchAsync(  
                searchTerm: null, rideId: null, isCrowded: null,  
                minVisitorCount: null, maxVisitorCount: null,  
                minQueueLength: null, maxQueueLength: null,  
                minWaitingTime: null, maxWaitingTime: null,  
                recordTimeFrom: null, recordTimeTo: cutoffDate,  
