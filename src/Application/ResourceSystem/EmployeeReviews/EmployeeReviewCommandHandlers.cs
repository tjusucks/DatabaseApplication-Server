...
namespace DbApp.Application.ResourceSystem.EmployeeReviews
{
    ...
    // 考勤扣分命令处理程序
    public class CreateAttendanceDeductionCommandHandler : IRequestHandler<CreateAttendanceDeductionCommand, int>
    {
        private readonly IEmployeeReviewRepository _employeeReviewRepository;
        private readonly IAttendanceRepository _attendanceRepository;

        public CreateAttendanceDeductionCommandHandler(
