...
public class RefundController(IMediator mediator) : ControllerBase
{
    ...
    [HttpPost("request")]
    public async Task<ActionResult<RefundResultDto>> RequestRefund(
    ...
    [HttpPost("batch")]
    public async Task<ActionResult<BatchRefundResultDto>> BatchRefund(
        [FromBody] BatchRefundCommand command)
    {
        var result = await _mediator.Send(command);
        return Ok(result);
    }
    ...
    [HttpGet("search")]
    public async Task<ActionResult<RefundSearchResultDto>> SearchRefunds(
        [FromQuery] SearchRefundRecordsQuery query)
    {
    ...
    [HttpGet("{id}")]
    public async Task<ActionResult<RefundDetailsDto>> GetRefundById(int id)
    {
    ...
    public async Task<ActionResult<RefundDetailsDto>> GetRefundByTicketId(int ticketId)
    {
    ...
    [HttpGet("stats")]
    public async Task<ActionResult<RefundStatsDto>> GetRefundStats(
        [FromQuery] GetRefundStatsQuery query)
    {
        var result = await _mediator.Send(query);
        return Ok(result);
    }
