...
[ApiController]
[Route("api/resource/maintenance")]  // 简化路径  
public class MaintenanceRecordsController(IMediator mediator) : ControllerBase
{
    ...
    /// </summary>    
    /// <param name="searchTerm">Search term for maintenance details or parts replaced.</param>    
        ...
        [FromQuery] int pageSize = 10)
    {
        var result = await _mediator.Send(new SearchMaintenanceRecordsQuery(
            searchTerm, rideId, teamId, managerId, maintenanceType, isCompleted, isAccepted,
