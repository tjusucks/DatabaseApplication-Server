...
[ApiController]
[Route("api/resource/inspections")]
public class InspectionRecordsController(IMediator mediator) : ControllerBase
{
    ...
    /// </summary>
    /// <param name="keyword">Keyword for issues or recommendations.</param>
        ...
        [FromQuery] int pageSize = 10)
    {
        var result = await _mediator.Send(new SearchInspectionRecordsQuery(
            keyword, rideId, teamId, checkType, isPassed, checkDateFrom, checkDateTo, page, pageSize));
        return Ok(result);
    }
